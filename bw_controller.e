...
static void zim_bw_controller_display(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used );
static const zend_arg_info arginfo_bw_controller_display[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0},
    { "event_name", sizeof("event_name")-1, ((void *)0), 0, 0, 0, 0},
};
const zend_function_entry bw_controller_methods[] =
{
    { "display", zim_bw_controller_display, ((void *)0), (zend_uint) (sizeof(((void *)0))/sizeof(struct _zend_arg_info)-1), 0x100 },
    { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
void bw_controller_init(int module_number )
{
    { const char *cl_name = "bw_controller"; int _len = sizeof("bw_controller")-1; bw_controller_ce.name = zend_new_interned_string(cl_name, _len+1, 0 ); if (bw_controller_ce.name == cl_name) { bw_controller_ce.name = zend_strndup(cl_name, _len); } bw_controller_ce.name_length = _len; { bw_controller_ce.constructor = ((void *)0); bw_controller_ce.destructor = ((void *)0); bw_controller_ce.clone = ((void *)0); bw_controller_ce.serialize = ((void *)0); bw_controller_ce.unserialize = ((void *)0); bw_controller_ce.create_object = ((void *)0); bw_controller_ce.interface_gets_implemented = ((void *)0); bw_controller_ce.get_static_method = ((void *)0); bw_controller_ce.__call = ((void *)0); bw_controller_ce.__callstatic = ((void *)0); bw_controller_ce.__tostring = ((void *)0); bw_controller_ce.__get = ((void *)0); bw_controller_ce.__set = ((void *)0); bw_controller_ce.__unset = ((void *)0); bw_controller_ce.__isset = ((void *)0); bw_controller_ce.serialize_func = ((void *)0); bw_controller_ce.unserialize_func = ((void *)0); bw_controller_ce.serialize = ((void *)0); bw_controller_ce.unserialize = ((void *)0); bw_controller_ce.parent = ((void *)0); bw_controller_ce.num_interfaces = 0; bw_controller_ce.traits = ((void *)0); bw_controller_ce.num_traits = 0; bw_controller_ce.trait_aliases = ((void *)0); bw_controller_ce.trait_precedences = ((void *)0); bw_controller_ce.interfaces = ((void *)0); bw_controller_ce.get_iterator = ((void *)0); bw_controller_ce.iterator_funcs.funcs = ((void *)0); bw_controller_ce.info.internal.module = ((void *)0); bw_controller_ce.info.internal.builtin_functions = bw_controller_methods; } };
    bw_controller_class_entry_ptr = zend_register_internal_class(&bw_controller_ce);
}
static void zim_bw_controller_display(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
  zval *t_key,*data;
  if (zend_parse_parameters((ht) , "zz", &t_key, &data) == FAILURE)
  {
      return;
  }
  zval function = {{0}, 0},*param[] = {data};
  do { const char *__s=("extract"); zval *__z = (&function); (*__z).value.str.len = strlen(__s); (*__z).value.str.val = (0?_estrndup((__s), ((*__z).value.str.len) ):(char*)__s); (*__z).type = 6; } while (0);
  if (call_user_function((executor_globals.function_table), ((void *)0), &function, return_value, 1, param ) == FAILURE) {
    if (return_value) {
      _zval_dtor((return_value) );
    }
    php_error_docref0(((void *)0) , (1<<1L), "display:call function 'extract' error!");
    { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
  }
  char *root = (binwin_globals.root),*tpl_file;
  int len = spprintf(&tpl_file,0,"%s/view/%s.php",root, (*t_key).value.str.val);
  zval* controller = __request_query(1, ("c"), (sizeof("c")-1) );
  if(((*controller).type==0)){
    return;
  }
  int *a = makemem();
  php_error_docref0(((void *)0) , (1<<1L), "*a=%d",*a);
  bw_loader_import(tpl_file,len, 0 );
}
